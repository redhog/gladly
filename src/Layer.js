export class Layer {
  constructor({ type, attributes, uniforms, nameMap = {}, domains = {}, xAxis = "xaxis_bottom", yAxis = "yaxis_left", xAxisQuantityKind, yAxisQuantityKind, colorAxes = [], filterAxes = [], vertexCount = null }) {
